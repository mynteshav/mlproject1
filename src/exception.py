...
def error_message_detail(error,error_detail:sys):
    ...
    file_name=exc_tb.tb_frame.f_code.co_filename # This line shows the file name in which the error is occurred.
    error_message="Error occured in python script name[{0}] line number [{1}] error message[{2}]".format(
        file_name,exc_tb.tb_lineno,str(error) # This is for line.
